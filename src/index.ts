import { app, BrowserWindow, dialog, ipcMain, OpenDialogSyncOptions } from 'electron';
...
ipcMain.handle("showDialog", () => {
  const options: OpenDialogSyncOptions = { title: "asdf" };
  dialog.showOpenDialogSync(BrowserWindow.getFocusedWindow()!, options);
});
